...
#roulette wheel selection (prob=fitness(i)/sum_fitness)+ single point crossover(rate 0.7)  + mutation (rate 0.8) 
...
def roulette_wheel_selection(fitness, num_parents, population):
...
def optimize(weight, value, population, pop_size, num_generations, threshold):
    ...
    for i in range(num_generations):
        ...
        #print(population)
        population = roulette_wheel_selection(fitness, num_parents, population)
        #print("selection:")
        #print(population)
...
def roulette_wheel_selection_and_single_point_crossover(numberOfElements, listOfElements , backPackSize):
