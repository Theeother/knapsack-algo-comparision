...
#determinist selection(best 50%)+ single point crossover(rate 0.7) + mutation (rate 0.8) 
...
def determinist_selection_and_single_point_crossover(numberOfElements, listOfElements , backPackSize):
